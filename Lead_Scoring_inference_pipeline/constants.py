...
DB_FILE_MLFLOW_PATH = '/home/CodePro_Assignment/03_inference_pipeline/scripts/'
DB_FILE_MLFLOW = "Lead_scoring_mlflow_production.db"

FILE_PATH = '/home/CodePro_Assignment/03_inference_pipeline/scripts/prediction_distribution.txt'

TRACKING_URI = 'http://0.0.0.0:6006'

# experiment, model name and stage to load the model from mlflow model registry
MODEL_NAME = '/home/mlruns/3/e0db472061134ec48468e10fe317319f/artifacts/models'
STAGE = 'production'
