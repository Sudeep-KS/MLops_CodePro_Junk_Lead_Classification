...
## Test using command: python -m pytest
...
def test_load_data_into_db():
    ...
    cnx = sqlite3.connect('/home/CodePro_Assignment/01_data_pipeline/scripts/unit_test/utils_output.db')
    print("Reading data from loaded_data table")
    loaded_data = pd.read_sql('select * from loaded_data', cnx)
    print("loaded_data shape: ", loaded_data.shape)
    
    print("Connecting to database")
    cnx_test = sqlite3.connect('/home/CodePro_Assignment/01_data_pipeline/scripts/unit_test/unit_test_cases.db')
